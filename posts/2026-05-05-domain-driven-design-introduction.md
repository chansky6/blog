---
date: 2026-05-05
title: "阿里技术专家详解 DDD 系列- Domain Primitive"
category: 架构
tags:
  - DDD
  - Domain Primitive
  ...
  - Value Object
  - 架构设计
description: 介绍 Domain Primitive 的定义、三原则、与 Value Object/DTO 的区别，以及在老系统中逐步重构到 DP 的实践步骤。
source: "https://developer.aliyun.com/article/716908"
---
> 转自 https://developer.aliyun.com/article/716908 
...
| 维度 | DTO | DP |
| --- | --- | --- |
| 功能 | 数据传输<br>属于技术细节 | 代表业务域中的概念 |
| 数据的关联 | 只是一堆数据放在一起<br>不一定有关联度 | 数据之间的高相关性 |
| 行为 | 无行为 | 丰富的行为和业务逻辑 |
